...
// The CreateLoadBalancerListeners request parameters
type CreateLoadBalancerListeners struct {
	Listeners        []Listener
	LoadBalancerName string
}

func (elb *ELB) CreateLoadBalancerListeners(options *CreateLoadBalancerListeners) (resp *SimpleResp, err error) {
	params := makeParams("CreateLoadBalancerListeners")
...
// The SetLoadBalancerListenerSSLCertificate request parameters
type SetLoadBalancerListenerSSLCertificate struct {
	LoadBalancerName string
	LoadBalancerPort int64
	SSLCertificateId string
}

func (elb *ELB) SetLoadBalancerListenerSSLCertificate(options *SetLoadBalancerListenerSSLCertificate) (resp *SimpleResp, err error) {
	params := makeParams("SetLoadBalancerListenerSSLCertificate")

	params["LoadBalancerName"] = options.LoadBalancerName
	params["LoadBalancerPort"] = strconv.FormatInt(options.LoadBalancerPort, 10)
	params["SSLCertificateId"] = options.SSLCertificateId
